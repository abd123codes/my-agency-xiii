...
export const Main = () =>{
    return (
      <main className="border w-[max(375px,100%)]">
        ...
        <div className="border w-[max(325px,86.67vw)] mx-auto mt-[max(58px,15.47vw)] flex flex-col gap-[max(47px,12.53vw)]">
          ...
          <div className="flex flex-col gap-[max(32px,8.53vw)]">
            ...
            <div>
              <div className="text-[#015450]">50+</div>
              <div>Projects</div>
              <div>
