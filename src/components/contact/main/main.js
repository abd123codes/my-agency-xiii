...
export const Main = () => {
  ...
  return (
    <div className="min-w-[max(375px,100%)]">
      ...
      <div className="w-[87.2%] h-[max(13.4375rem,57.33vw)] mx-auto mt-[max(2.5625rem,10.93vw)] rounded-[max(0.5rem,2.133vw)] tablet:w-[79.17vw] tablet:mt-[5.21vw] bg-contact-img bg-cover bg-no-repeat bg-center tablet:h-[33.85vw] rounded-[0.42vw]"></div>
      <form
      ...
      >
        ...
        <div className='flex flex-col gap-[max(1.5rem,6.4vw)] tablet:flex-row tablet:gap-[0] tablet:justify-between'><input
            type="text"
            name="firstName"
            id="firstName"
